...
//
//  INSTRUCTIONS:
//  1. Save this as "gtfs-realtime.proto"
//  2. Install protoc: brew install protobuf
//  3. Generate Swift code: protoc --swift_out=. gtfs-realtime.proto
//  4. Add the generated .pb.swift file to your Xcode project
//

/*
syntax = "proto2";
option swift_package = "TransitRealtime";
...
Once you've generated the Swift protobuf files, use them like this:
...
func parseGTFSData(_ data: Data) throws -> [Train] {
    ...
    for entity in feedMessage.entity {
        if entity.hasTripUpdate {
            let trip = entity.tripUpdate.trip
            let routeID = trip.routeID
            let direction = trip.directionID == 0 ? "North" : "South"
